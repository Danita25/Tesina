		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSimpleAccess().getComparacionAssignment_1(), "rule__Simple__ComparacionAssignment_1");
					put(grammarAccess.getSimpleAccess().getExpresion_derAssignment_2(), "rule__Simple__Expresion_derAssignment_2");
