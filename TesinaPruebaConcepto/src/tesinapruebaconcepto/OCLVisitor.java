 ...
 */
public class OCLVisitor<C, O, P, EL, PM, S, COA, SSA, CT>
	 ...
	 */
	protected OCLVisitor(Environment<?, C, O, P, EL, PM, S, COA, SSA, CT, ?, ?> env) {
	    this.env = env;
	...
	OCLVisitor<C, O, P, EL, PM, S, COA, SSA, CT> getInstance(
			Environment<?, C, O, P, EL, PM, S, COA, SSA, CT, ?, ?> env) {
		
		return new OCLVisitor<C, O, P, EL, PM, S, COA, SSA, CT>(env);
	}
	...
	OCLVisitor<C, O, P, EL, PM, S, COA, SSA, CT> getInstance(
		...
		return new OCLVisitor<C, O, P, EL, PM, S, COA, SSA, CT>(
