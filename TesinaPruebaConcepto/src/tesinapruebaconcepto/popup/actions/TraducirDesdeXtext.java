...
public class TraducirDesdeXtext {
	...
	public boolean testOutput (String actual){
		String expected = "\"Las siguientes afirmaciones deben ser verdaderas en el sistema:\" .\r\n"
				...
				+ " entre los libros de un/una Biblioteca existe uno tal que el/la titulo de un/una Libro es igual a \"El Principito\" .\r\n"
				+ " entre los libros de un/una Biblioteca existe uno tal que el/la nombre de el/la autor de un/una Libro es igual a \" Antoine de Saint-Exupery\" y el/la titulo de un/una Libro es igual a \"El Principito\" .\r\n"
				+ " entre los libros de un/una Biblioteca existe uno tal que el/la titulo de un/una Libro es igual a \"El Principito\" y entre los libros de un/una Biblioteca existe uno tal que el/la titulo de un/una Libro es igual a \"Harry potter\" .\r\n"
				...
				+ " entre los libros de un/una Biblioteca tal que el/la nombre de el/la autor de un/una Libro es igual a \"Paulo Coelho\" existe uno tal que el/la titulo de un/una Libro es igual a \"Veronica decide morir\" .\r\n"
