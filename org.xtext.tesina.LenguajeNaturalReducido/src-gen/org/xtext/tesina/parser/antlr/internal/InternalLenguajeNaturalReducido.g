...
// Entry rule entryRuleExpresionDerecha
entryRuleExpresionDerecha returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getExpresionDerechaRule()); }
	iv_ruleExpresionDerecha=ruleExpresionDerecha
	{ $current=$iv_ruleExpresionDerecha.current; }
	EOF;

// Rule ExpresionDerecha
ruleExpresionDerecha returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleIteracion
entryRuleIteracion returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIteracionRule()); }
	iv_ruleIteracion=ruleIteracion
	{ $current=$iv_ruleIteracion.current; }
	EOF;

// Rule Iteracion
ruleIteracion returns [EObject current=null]
@init {
	enterRule();
}
@after {
			...
			(
				(
					...
					}
					{
					    ...
					    |
					lv_determinante_0_2='todos los/las'
					{
