 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.tesina.lenguajeNaturalReducido.impl.OracionImpl#getContenido <em>Contenido</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OracionImpl extends MinimalEObjectImpl.Container implements Oracion
{
  ...
  public NotificationChain basicSetContenido(Contenido newContenido, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LenguajeNaturalReducidoPackage.ORACION__CONTENIDO, oldContenido, newContenido);
  ...
  public void setContenido(Contenido newContenido)
  {
    if (newContenido != contenido)
    {
      ...
      if (contenido != null)
        msgs = ((InternalEObject)contenido).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LenguajeNaturalReducidoPackage.ORACION__CONTENIDO, null, msgs);
      if (newContenido != null)
        msgs = ((InternalEObject)newContenido).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LenguajeNaturalReducidoPackage.ORACION__CONTENIDO, null, msgs);
      msgs = basicSetContenido(newContenido, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LenguajeNaturalReducidoPackage.ORACION__CONTENIDO, newContenido, newContenido));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LenguajeNaturalReducidoPackage.ORACION__CONTENIDO:
