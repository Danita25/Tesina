...
public class OCL2LNR {
	 ...
	 * @generated
	 */
	public OCL2LNR() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("OCL2LNR.properties").openStream());
	...
	public void loadModels(String inModelPath) throws ATLCoreException, MalformedURLException, IOException {
		...
		injector.inject(lnrMetamodel, getMetamodelUri("LNR"));
	 ...
	 * @generated
	 */
	public Object doOCL2LNR(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
		ILauncher launcher = new EMFVMLauncher();
		Map<String, Object> launcherOptions = getOptions();
		launcher.initialize(launcherOptions);
		launcher.addInModel(inModel, "IN", "OCL");
		launcher.addOutModel(outModel, "OUT", "LNR");
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("OCL2LNR.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("OCL2LNR.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("OCL2LNR.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("OCL2LNR.options.")) {
				options.put(entry.getKey().toString().replaceFirst("OCL2LNR.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = OCL2LNR.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = OCL2LNR.class.getResource(fileName);
		}
		if (fileURL == null) {
